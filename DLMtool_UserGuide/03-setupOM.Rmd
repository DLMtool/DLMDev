...
setwd(file.path(getwd(), 'ExampleOM'))
```
...
```{r OM-init, message=FALSE, warning=FALSE, include=FALSE}
OMinit('example', overwrite = TRUE)
```



```{r OM-init2, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
OMinit('MyOM')
```

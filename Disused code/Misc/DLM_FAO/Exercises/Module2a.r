...
# Task 5 validate install with version command

# Task 6 do default runMSE (to check for errors) - this is the last thing to do because some computers hang here with the parallel processing 
# doing this at the end of the practical means we have a pause to sort everyone out

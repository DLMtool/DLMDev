...
# =====================================================================================
# === DLMtool Exercise 2c: Modifying operating models  ================================
# =====================================================================================
# 
...
Albacore <- new('Stock', "D:/DLM_DFO/Exercises/Data/CSV/Albacore.csv")
...
Mack2 <- Mackerel            # Copy the Mackerel Stock object

Mack2@Name <- "MackerelMod"  # Change the name of the stock 
Mack2@M <- c(0.2, 0.35)      # Higher natural mortality 
Mack2@D <- c(0.05, 0.2)      # More uncertain level of current stock depletion 
...
#
# Q3.3  Can you explain why certain MPs perform worse in MSE2?
#
# Q3.4  Are any MPs 'dominated' with respect to all metrics and can therefore
#       be discarded?
#
# Q3.5  In MSE 1, what are the prevalent trade-offs - what compromises are managers
#       facing?

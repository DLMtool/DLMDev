...
#' runMSE(testOM)
#' }
StochasticSRA_SL<-function(OM,CAA,Chist,Cobs=0.1,sigmaR=0.5,Umax=0.9,nsim=48,proyears=50,
...
environment(StochasticSRA_SL) = asNamespace("DLMtool")

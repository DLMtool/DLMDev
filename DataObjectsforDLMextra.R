...
# Run this code to write files to DLMextra/data 
...
fromData <- file.path(localDir, "DLMextra_Data")
pkgpath <- file.path(localDir, "../DLMextra")
...
cat("# This file is automatically built by DataObjectsforDLMextra.r in DLMDev\n",
    "# Don't edit by hand!\n", 
    "# \n\n", sep="", append=TRUE, 
